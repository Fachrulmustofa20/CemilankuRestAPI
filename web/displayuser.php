...
<div class="row">
			...
			<div class="row">
				<div class="col-md-3">
				<a class="btn btn-primary" href="<?php echo "index_admin.php?page=tambahuser"?>"><i class="icon_plus_alt2"></i> Tambah</a>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 <th><i class="icon_profile"></i> Id User</th>
...
<?php
  ...
  //echo "<a href='tambahUser.php'>Add</a>";
 	while ($hasil = mysqli_fetch_array ($sql)) {
		...
		<td>
		                          <div class="btn-group">
                                      <a class="btn btn-success" href="<?php echo "index_admin.php?page=edituser&id=$kode"?>"><i class="icon_check_alt2"></i> Edit</a>
                                      <a class="btn btn-danger" onClick='return tanya()' href="<?php echo "index_admin.php?page=hapususer&id=$kode"?>"><i class="icon_close_alt2"></i> Hapus</a>
                                  </div>
                                  </td>
                              </tr>
	        <?php } ?>
